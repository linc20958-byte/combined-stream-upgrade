...
var { finished } = require('node:stream/promises');
...
test('unpaused streams: second stream may buffer while first drains', async function () {
  ...
  var tmpFile = common.dir.tmp + '/combined-unpaused.txt';
